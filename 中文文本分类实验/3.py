...
if __name__ == '__main__':  
    ...
    stopword_path = "./train_word_bag/hlt_stop_words.txt"#输入的文件  
  
    train_bunch_path = "./train_word_bag/train_set.dat"#输入的文件  
    space_path = "./train_word_bag/tfidfspace.dat"#输出的文件  
    vector_space(stopword_path,train_bunch_path,space_path)  
  
    train_tfidf_path = "./train_word_bag/tfidfspace.dat"  # 输入的文件，由上面生成  
    test_bunch_path = "./test_word_bag/test_set.dat"#输入的文件  
    test_space_path = "./test_word_bag/testspace.dat"#输出的文件  
