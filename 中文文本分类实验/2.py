...
if __name__ == "__main__":#这个语句前面的代码已经介绍过，今后不再注释
    #对训练集进行Bunch化操作：
    wordbag_path = "./train_word_bag/train_set.dat"  # Bunch存储路径，程序输出
    seg_path = "./train_corpus_seg/"  # 分词后分类语料库路径，程序输入
    corpus2Bunch(wordbag_path, seg_path)
 
    # 对测试集进行Bunch化操作：
    wordbag_path = "./test_word_bag/test_set.dat"  # Bunch存储路径，程序输出
    seg_path = "./test_corpus_seg/"  # 分词后分类语料库路径，程序输入
    corpus2Bunch(wordbag_path, seg_path)